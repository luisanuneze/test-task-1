<template>
  <div v-if="loaded">
    <HeaderSection :header="dataSectionHeader" :background_image="dataSectionHeader.background_image"/>
    <HowItWorks :howItWorksSection="dataSectionHowItWorks"/>
    <div class="benefits-section-wrapper">
      <SectionBenefits :sectionBenefits="datasectionBenefits" :title="datasectionBenefits.title"/>
    </div>
